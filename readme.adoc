...
* Exercise 5.5.1: open the project link:hands-on/lab5/smart-room-org[`hands-on/lab5/smart-room-org`]. In the code of the link:hands-on/lab5/smart-room-org/src/personal_assistant.asl[`personal assistant`], remove the latest line of the plan `+!vote_done`. Run the application and compare the achieved temperature with the votes of the agents. Check what might be wrong.
