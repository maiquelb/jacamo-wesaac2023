...
* Exercise 2.3.3: open the project in folder `lab2/e233` and take a look at the room controller program. There is a difference in the plan in lines 16-18. Run the application and evaluate the problems of this implementation. Some ideas about how to fix?
