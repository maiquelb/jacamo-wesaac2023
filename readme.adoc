...
* Exercise 2: open the http://127.0.1.1:3272 [_mind inspector_] for agent `rc` and compare the beliefs there with those identified in the program. Are they the same? Are they represented the same way? 
