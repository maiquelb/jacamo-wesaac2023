...
To run the smart room project, open the folder link:hands-on/labs/smart-room[`hands-on/lab5/smart-room`] with the Visual Studio Code (or access it in the terminal).  Then, run the project by typing the command below in the terminal:
----
