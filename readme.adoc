...
* Exercise 5.1.4: compare the code of the link:hands-on/lab5/smart-room-org/src/agt/personal_assistant.asl[_personal assistant_] of this task with the link:hands-on/lab5/smart-room-vm/src/agt/personal_assistant.asl[one of the previous Lab4]. What are the differences? 
