...
* Exercise 5.5.2: open the project link:hands-on/lab5/smart-room-org-inst[`hands-on/lab5/smart-room-org-inst`]. Compare the organization entity definition at link:hands-on/lab5/smart-room-org-inst/smart-room.jcm[smart-room.jcm] with link:hands-on/lab5/smart-room-org/smart-room.jcm[the one of the previous task]. What is different?
