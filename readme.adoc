...
The slides presented in the tutorial are available link:https://www.dropbox.com/scl/fi/2vkn8ny6mu0mtfduwwxsv/slides.pdf?rlkey=vs8595b9idwegsijiyzzaqj3b&dl=0[here].
...
* Java JDK 17+
* Visual Studio Code
* link:https://github.com/jacamo-lang/jacamo/blob/master/doc/install.adoc[JaCaMo Command Line Interface] (a script for installation on Linux is available link:https://www.dropbox.com/scl/fi/50u1tav7q8nwdnh8ado0b/install_jacamo.sh?rlkey=bjtppgs1qz6hsd427qt1tjfbk&dl=0[here])
